...
public class Out {
  ...
  public static void compareTo(String fn) {
    ...
    //if (!"run".equalsIgnoreCase(System.getenv("ACTION"))) return;
  ...
  public static void finalize_out() {
    if(comparing_to && compareToScanner.hasNextLine()) {
      System.out.print("\033[31m");
      System.out.println("Your output has fewer lines than expected!!");
